...
(2)Adjacency matrix a factor graph, 1:="The parent node(compound) of a reaction(M_i).", -1:="The child node(compound) of a reaction(M_i)", 0:="No connection bewteen compound and reaction". 

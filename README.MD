...
You can find the results in the directory "outputs", please click [here](https://github.com/ptdang1001/MPOSNN) to see the output examples(Just for testing, no mearning):

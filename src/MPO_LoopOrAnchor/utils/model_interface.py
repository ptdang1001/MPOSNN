...
from MPO_LoopOrAnchor.utils.data_interface import build_bipartite_graph
from MPO_LoopOrAnchor.utils.data_interface import get_cycles
    ...
    def _init_msg_nodes2factors(self):
        for node_i, parent_child in self.nodes.items():
            ...
            for parent_factor_i in parent_factors:
                ...
                self._msg_nodes2factors[(node_i, parent_factor_i)] = float(self.belief[node_i])
            ...
            for child_factor_i in child_factors:
                ...
                self._msg_nodes2factors[(node_i, child_factor_i)] = float(self.belief[node_i])
